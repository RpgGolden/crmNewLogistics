...
function PopUpEditDriver() {
    ...
    const [idSelectDriver, setidSelectDriver] = useState("");
    ...
    useEffect(() => {
        setidSelectDriver(context.selectedTr)
    ...
    return (
        <PopUpContainer title={"Редактирование водителя"} mT={50}>
            <div className={styles.newCarInDriver}>
                ...
                <Input Textlabel={"Отчество:"} value={dataNewClient.patronymic} handleInputChange={handleInputChange} name="patronymic"/>
                <div className={styles.TwoInput}>
                    <Input Textlabel={"Телефон:"} value={dataNewClient.phoneNumber} handleInputChange={handleInputChange} name="phoneNumber"/>
                    <Input Textlabel={"ИНН:"} value={dataNewClient.inn} handleInputChange={handleInputChange} name="inn"/>
                </div>
                <div className={styles.TwoInput}>
                    <Input Textlabel={"Доп телефон:"} value={dataNewClient.additionalPhoneNumber} handleInputChange={handleInputChange} name="additionalPhoneNumber"/>
                    <Input Textlabel={"СНИЛС:"} value={dataNewClient.snils} handleInputChange={handleInputChange} name="snils"/>
                </div>
                <h3>Паспортные данные</h3>
                <div className={styles.TwoInput}>
                    <Input Textlabel={"Серия:"} value={dataNewClient.passportSerial} handleInputChange={handleInputChange} name="passportSerial"/>
                    <Input Textlabel={"Номер:"} value={dataNewClient.passportNumber} handleInputChange={handleInputChange} name="passportNumber"/>
                </div>
                ...
                <div className={styles.ThreeInput}>
                    <Input Textlabel={"Серия, номер:"} value={dataNewClient.numberLicense} handleInputChange={handleInputChange} name="numberLicense"/>
                    <Input Textlabel={"Категория ВУ:"} value={dataNewClient.categoryLicense} handleInputChange={handleInputChange} name="categoryLicense"/>
                    <Input Textlabel={"Период действия:"} value={dataNewClient.periodLicense} handleInputChange={handleInputChange} name="periodLicense"/>
                </div>
                <h3>Прописка</h3>
